...
/** Build a minimal stored (uncompressed) ZIP — enough for a valid .docx OOXML package. */
export const createStoredZip = (files: Array<{name: string; content: string | Uint8Array}>) => {
